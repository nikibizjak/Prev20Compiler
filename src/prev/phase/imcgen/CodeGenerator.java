...
public class CodeGenerator extends AstNullVisitor<Object, Stack<MemFrame>> {
	...
	public Object visit(AstFunDecl funDecl, Stack<MemFrame> frames) {
		// Because of this implementation, each function will on its declaration
		// have a parent function inside the frames stack, we don't have to
		// search for parent in frames
